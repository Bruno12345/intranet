...
include("../topo.php");
    ...
    ?>
     <div class="mws-panel grid_8">
           <div class="mws-panel-header">
                    <span class="mws-i-24 i-table-1">Categorias - Banco de Imagens</span>
            </div>
    ...
    $SQL = "SELECT f.id, f.imagem, c.nome FROM imagens f INNER JOIN categoria_imagens c ON f.categoria_imagens_id = c.id;";
    $resultado = mysql_query($SQL) or die(mysql_error());
    $total = mysql_num_rows($resultado);
    if($total > 0){
    ?>
     <div class="mws-panel grid_8">
           <div class="mws-panel-header">
                    <span class="mws-i-24 i-table-1">Banco de Imagens</span>
            </div>
            <div class="mws-panel-body">
                <div class="mws-panel-toolbar top clearfix">
                    <ul>
                ...
                <table class="mws-datatable mws-table">
                    ...
                    <tbody>
                       ...
                       while($linhas = mysql_fetch_array($resultado)){
                        ...
                        ?>
                            <tr>
                                <td><a href="./arquivos/<?=$id?>/<?=$imagem?>"><?=$imagem;?></td>
                                <td><?=$nome;?></td>
    ...
    <?  
        ...
        ?>
         <div class="mws-panel grid_8">
                <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">Imagens</span>
            </div>
            <div class="mws-panel-body">
                <div class="mws-panel-toolbar top clearfix">
                    <ul>
