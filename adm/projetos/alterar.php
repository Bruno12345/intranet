  ...
  if(is_uploaded_file($_FILES["imagem"]["tmp_name"])){
    ...
    if($erros == NULL){
      ...
      if(is_uploaded_file($_FILES["imagem"]["tmp_name"])){
          ...
          $SQL = "SELECT imagem FROM projetos WHERE id = $empresa_id";
          ...
          mysql_query($SQL) or die($SQL." - ".mysql_error());
           ...
           if(is_uploaded_file($_FILES["foto1"]["tmp_name"])){
            ...
            $SQL = "SELECT foto1 FROM projetos WHERE id = $empresa_id";                      
            $fotoAtual = mysql_result(mysql_query($SQL),0);
            ...
            $SQL = "UPDATE projetos SET foto1 = '$foto1' WHERE id = $empresa_id;";         
            mysql_query($SQL) or die($SQL." - ".mysql_error());
          ...
          if(is_uploaded_file($_FILES["foto2"]["tmp_name"])){
            ...
            $SQL = "SELECT foto2 FROM projetos WHERE id = $empresa_id";                      
            $fotoAtual = mysql_result(mysql_query($SQL),0);
            ...
            $SQL = "UPDATE projetos SET foto2 = '$foto2' WHERE id = $empresa_id;";         
            mysql_query($SQL) or die($SQL." - ".mysql_error());
...
<script type="text/javascript" src="../../engine/ckeditor/ckeditor.js"></script>
    ...
    <div class="mws-panel grid_8">
       <div class="mws-panel-header">
            <span class="mws-i-24 i-list">Alterar Projeto</span>
       </div>
