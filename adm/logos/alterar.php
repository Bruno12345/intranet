...
if($_POST){
  ...
  if($erros == NULL){
      ...
      if(is_uploaded_file($_FILES["imagem"]["tmp_name"])){
        ...
        $SQL = "UPDATE logos SET categoria_logos_id = $categoria_id, imagem = '$arquivo' WHERE id = $id;";
        mysql_query($SQL) or die($SQL." - ".mysql_error());
        header("location: index.php");

      }else{    

        $SQL = "UPDATE logos SET categoria_logos_id = $categoria_id WHERE id = $id;";
        mysql_query($SQL) or die($SQL." - ".mysql_error());
        header("location: index.php");
      }
                ...
                <div class="mws-form-row">
                  ...
                  <div class="mws-form-item large">
                      <select name="categoria_id">
                        ...
                        ?>
                        <option value="<?=$linha['id'];?>" <?marcaSelect($linha['id'], $categoria_logos_id)?>><?=$linha['nome'];?></option>
                        <?php
                        }
                        ?>
                      </select>
