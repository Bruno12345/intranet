...
if($_POST){
  ...
  if($erros == NULL){
      ...
      if(is_uploaded_file($_FILES["imagem"]["tmp_name"])){
        ...
        $SQL = "SELECT imagem FROM media WHERE id = $id";
        ...
        $SQL = "UPDATE media SET categoria_media_id = $categoria_id, imagem = '$arquivo' WHERE id = $id;";
        mysql_query($SQL) or die($SQL." - ".mysql_error());
        header("location: index.php");

      }else{    

        $SQL = "UPDATE media SET categoria_media_id = $categoria_id WHERE id = $id;";
        mysql_query($SQL) or die($SQL." - ".mysql_error());
        header("location: index.php");
      }
       ...
       <div class="mws-panel-header">
        ...
        <div class="mws-panel-body">
                ...
                <div class="mws-form-row">
                  ...
                  <div class="mws-form-item large">
                      <select name="categoria_id">
                        ...
                        ?>
                        <option value="<?=$linha['id'];?>" <?marcaSelect($linha['id'], $categoria_media_id)?>><?=$linha['nome'];?></option>
                        <?php
                        }
                        ?>
                      </select>
                ...
                <div class="mws-form-row">
                 ...
                 <div class="mws-form-row">
                    <label >Arquivo</label>
                    <a href="./arquivos/<?=$id;?>/<?=$imagem;?>" alt="<?=$nome;?>"><?=$imagem;?></a>
                </div>
          </div>
