...
if(!$_GET){
    ...
    $SQL = "SELECT e.*, DAY(e.data_inicio) AS diaI, MONTH(e.data_inicio) AS mesI, DAY(e.data_fim) AS diaF, MONTH(e.data_fim) AS mesF, p.nome AS empresa FROM eventos e INNER JOIN empresa p ON e.empresa_id = p.id WHERE e.data_inicio >= CURDATE() AND e.empresa_id = $id ORDER BY e.data_inicio ASC;";
        ...
        <?
            ...
            while($linha = mysql_fetch_array($resultado)){
                ...
                <div class="item-lista-categoria">
                 ...
                 </div><!-- aqui carrega imagem do evento -->
